...
export default function Footer() {
  ...
  return (
    <footer className="bg-heart-charcoal-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-heart-charcoal-400 text-sm">
              {t('tagline')}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-heart-charcoal-400 hover:text-white transition-colors text-sm">
                  {nav('home')}
                </Link>
              </li>
              <li>
                <Link href="/apartments" className="text-heart-charcoal-400 hover:text-white transition-colors text-sm">
                  {nav('apartments')}
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-heart-charcoal-400 hover:text-white transition-colors text-sm">
                  {nav('about')}
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-heart-charcoal-400 hover:text-white transition-colors text-sm">
                  {nav('contact')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 text-heart-charcoal-400 hover:text-white transition-colors"
            >
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-8 border-t border-heart-charcoal-700">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-heart-charcoal-400 text-sm">
              © {currentYear} Little Heart Guesthouse. {t('copyright')}
            </p>
            <p className="text-heart-charcoal-500 text-sm flex items-center">
              {t('madeWith')} <span className="text-heart-coral-500 mx-1">&#10084;</span> in Interlaken
            </p>
          </div>
        </div>
      </div>
